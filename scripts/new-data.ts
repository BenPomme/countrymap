// Additional data categories for The World Truth Map
// Sources: WHO, World Bank, OECD, various academic studies

// Health Data
export const HEALTH_DATA: Record<string, {
  lifeExpectancy: number | null;
  maleHeight: number | null;
  femaleHeight: number | null;
...
export const SEX_DATA: Record<string, {
  sexualPartners: number | null;
  divorceRate: number | null;
  lgbtAcceptance: number | null;
}> = {
...
// Demographics Data
export const DEMOGRAPHICS_DATA: Record<string, {
  ethnicDiversity: number | null;
...
// Education & IQ Data
export const EDUCATION_DATA: Record<string, {
  avgIQ: number | null;
...
export const LIFESTYLE_DATA: Record<string, {
  happinessIndex: number | null;
  workHoursWeek: number | null;
  internetPenetration: number | null;
  coffeeConsumption: number | null;
}> = {
...
export const FREEDOM_DATA: Record<string, {
...
// Extended Crime Data
export const CRIME_EXTENDED: Record<string, {
  gunOwnership: number | null;
